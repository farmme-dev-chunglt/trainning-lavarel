                        ...
                        @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="exampleInputEmail1"
                                    ...
                                    aria-invalid="true" value="{{ isset($product) ? $product->name : '' }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control" id="exampleInputEmail1"
                                    placeholder="Enter email" aria-describedby="exampleInputEmail1-error"
                                    aria-invalid="true" value="{{ isset($product) ? $product->description : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control" id="exampleInputEmail1"
                                    placeholder="Enter email" aria-describedby="exampleInputEmail1-error"
                                    aria-invalid="true" value="{{ isset($product) ? $product->price : '' }}">
                                @if ($errors->has('price'))
                                    <span id="exampleInputEmail1-error" class="error">
                                        {{ $errors->first('price') }}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="discount" class="form-control" id="exampleInputEmail1"
                                    placeholder="Enter email" aria-describedby="exampleInputEmail1-error"
                                    aria-invalid="true" value="{{ isset($product) ? $product->discount : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="imgUrl" class="form-control" id="exampleInputEmail1"
                                    placeholder="Enter email" aria-describedby="exampleInputEmail1-error"
                                    aria-invalid="true" value="{{ isset($product) ? $product->imgUrl : '' }}">
